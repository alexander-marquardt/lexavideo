...
The original bower.json file appeared as shown below.

However, we removed all of the bootstrap javascript because most of this functionality is covered by angular bootstrap.
