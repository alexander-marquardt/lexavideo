...
class UserModel(ndb.Model):
    ...
    lx_user_id = ndb.StringProperty(default=None)
    ...
    lx_user_is_registered = ndb.BooleanProperty(default=False)

    lx_creation_date = ndb.DateTimeProperty(auto_now_add=True)
